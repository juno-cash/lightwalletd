...
// Juno Cash: saplingActivation is Orchard activation (name kept for API compat).
// startSaplingCommitmentTreeSize should always be 0.
type DarksideMetaState struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	SaplingActivation              int32  `protobuf:"varint,1,opt,name=saplingActivation,proto3" json:"saplingActivation,omitempty"` // Juno Cash: Orchard activation height
	...
	StartSaplingCommitmentTreeSize uint32 `protobuf:"varint,4,opt,name=startSaplingCommitmentTreeSize,proto3" json:"startSaplingCommitmentTreeSize,omitempty"` // Always 0 for Juno Cash
